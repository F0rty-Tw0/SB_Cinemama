...
@Api(
  tags = "Theaters (OPTIONAL)",
  description = "- A secured endpoint for <b>Theaters</b>, requires a role of <b>ADMIN</b> to operate! - <em>(This endpoint was created for the testing and learning purposes only).</em>"
)

...
@Api(
  ...
  description = "- A secured endpoint for <b>Genres</b>, requires a role of <b>ADMIN</b> to operate! - <em>(This endpoint was created for the testing and learning purposes only).</em>"
)
